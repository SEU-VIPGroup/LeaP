# Point-cloud encoder adapted from 3D Diffusion Policy (DP3).
#   Ze et al., "3D Diffusion Policy: Generalizable Visuomotor Policy Learning
#   via Simple 3D Representations", RSS 2024.
#   https://github.com/YanjieZe/3D-Diffusion-Policy
# Reused here (largely unmodified) as LeaP's visual backbone.
import torch
...
class FlowPolicyEncoder(nn.Module):
    def __init__(self, 
        ...
        if pointnet_type in ("mlp", "pointnet"):
            if use_pc_color:
